                                ...
                                <div class="shop-product">
                                    <div id="myTabContent-2" class="tab-content">
                                      ...
                                      <asp:Repeater ID="RncH" runat="server" DataSourceID="SqlDataSource1">
                                       ...
                                       <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:JQKShopConnectionString %>" SelectCommand="SELECT * FROM [showNướcHoa]"></asp:SqlDataSource>
