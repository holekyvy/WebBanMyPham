<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LoginAdmin.aspx.cs" Inherits="TT_ShopJQK.Admin.LoginAdmin" EnableEventValidation="false" ValidateRequest="false" %>
...
<head runat="server">
    ...
    <!-- End layout styles -->
    <link rel="icon" href="../Anh/Logo/CaptureLogo.JPG" />
</head>
<body>
            ...
            <div class="col-lg-4 mx-auto">
              <div class="auth-form-light text-left p-5">
                <div class="brand-logo">
                  <img src="../Anh/Logo/CaptureLogo.JPG">
                </div>
                <h4>Xin Chào! </h4>
