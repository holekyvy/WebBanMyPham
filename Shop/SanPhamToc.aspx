                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <asp:Repeater ID="Rspt" runat="server" DataSourceID="SqlDataSource1" >
                                 ...
                                 <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:JQKShopConnectionString %>" SelectCommand="SELECT * FROM [showSảnPhẩmTóc]"></asp:SqlDataSource>
